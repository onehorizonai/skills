...
- `What worked`: 1-2 specific strengths anchored in actual completed items.
- `Growth area`: 1 concrete investment suggestion anchored in the data, framed as improvement rather than criticism.
...
```json
{
  ...
  "shareableSummary": "Week of Mar 25: 18 items shipped, 4 contributors, 6 initiative moves, 5 bug fixes, quality investment 33%"
}
```
...
- Do not force a shareable-summary heading.
